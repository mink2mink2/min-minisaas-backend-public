...
@router.post(
    ...
    요청 Body:
    {
      "naver_access_token": "Naver에서 발급받은 액세스 토큰"
    }

    동작:
    - Naver REST API로 토큰 검증 및 사용자 정보 조회
